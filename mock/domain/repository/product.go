...
func (m *MockProductRepository) Create(arg0 *entity.Product) (*entity.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductRepository) Delete(arg0 int64) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductRepository) GetByID(arg0 int64) (*entity.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductRepository) GetList(arg0 entity.GetListProductOption) ([]*entity.Product, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductRepositoryMockRecorder) GetList(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetList", reflect.TypeOf((*MockProductRepository)(nil).GetList), arg0)
}

// Update mocks base method.
func (m *MockProductRepository) Update(arg0 int64, arg1 *entity.Product) (*entity.Product, error) {
	m.ctrl.T.Helper()
